    ...
    <main className="appShell">
      ...
      <div className="workspace">
        ...
        <section className="metricStrip">
          <article><span>Needs attention</span><strong>2</strong><small>1 conflict · 1 missing file</small></article>
          <article><span>Processing</span><strong>1</strong><small>Agent run in progress</small></article>
          <article><span>Completed today</span><strong>14</strong><small>14 / 14 verified</small></article>
          <article className="privacyMetric"><span>Raw secrets sent to model</span><strong>0</strong><small>Protected by local authority</small></article>
        </section>
        ...
        <section className="queueLayout">
          ...
          <aside className="operationsRail">
            <div className="railCard spotlight">
              ...
              <h3>Review Maya&apos;s claim</h3>
              <p>ContextFlow found a ₹180 mismatch between the hotel invoice and verified payment. Policy can resolve it automatically.</p>
              <Link className="primaryLink" href="/claims/CF-1842">Open claim →</Link>
            </div>
